...
begin
    ...
    assert (exists(select 1 from core.visible_star_systems where star_system=1 and civilization=1 and quantity=3)), 'Star system visibility is not valid after creating colony ';
end;