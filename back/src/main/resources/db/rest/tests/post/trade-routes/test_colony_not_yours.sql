declare
    ...
    expected_error_message_ text := 'Origin must be a colony of ordering civilization.';
    planet_ bigint;
    result_ json;
begin
    ...
    result_ = rest.execute_api('/trade-routes', 'post', 'token_2', '{"origin":1, "destination":2, "resourceType":"wood", "quantity":11}'::jsonb, 0);
