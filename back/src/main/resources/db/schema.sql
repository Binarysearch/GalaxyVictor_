...
CREATE TABLE trade_routes(
    ...
    origin_planet bigint NOT NULL REFERENCES planets(id) ON UPDATE CASCADE ON DELETE CASCADE,
    destination_planet bigint NOT NULL REFERENCES planets(id) ON UPDATE CASCADE ON DELETE CASCADE,
    resource_type text NOT NULL REFERENCES resource_types(id) ON UPDATE CASCADE ON DELETE CASCADE,
    quantity integer NOT NULL CHECK(quantity > 0),
