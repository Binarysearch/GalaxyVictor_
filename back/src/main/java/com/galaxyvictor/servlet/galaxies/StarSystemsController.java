...
@WebServlet(urlPatterns = "/api/star-systems")
public class StarSystemsController extends ApiServlet {
	...
	public String getRequest(ApiRequest request) throws SQLException {
		...
		String result = executeQueryForJson("select core.get_star_systems(?);", token);
