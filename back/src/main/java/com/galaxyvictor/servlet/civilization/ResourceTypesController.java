...
@WebServlet(urlPatterns = "/api/resource-types")
public class ResourceTypesController extends ApiServlet {
	...
	public String getRequest(ApiRequest request) throws SQLException {
		...
		String result = executeQueryForJson("select core.get_resource_types(?);", token);
