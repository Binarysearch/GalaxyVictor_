...
@WebServlet(urlPatterns = "/api/civilizations")
public class CivilizationsController extends ApiServlet {
	...
	public String getRequest(ApiRequest request) throws SQLException {
		...
		String result = executeQueryForJson("select core.get_civilizations(?);", token);
